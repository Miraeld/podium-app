    ...
    <div className="animate-fade-in space-y-8">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white dark:bg-surface-2 border border-gray-100 dark:border-border rounded-xl p-4 flex items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              <Compass className="w-4 h-4 text-gray-700 dark:text-gray-500 mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">{tTour("settingsEntry.title")}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                  {tTour("settingsEntry.description")}
                </p>
              </div>
            </div>
            <button onClick={() => requestTourStart()} className="btn-ghost text-xs flex-shrink-0">
      ...
      <section>
        ...
        <div className="card p-5 space-y-5">
          ...
          {!notifUnavailable && notifPrefs.enabled && (
            <div className="space-y-3 pt-4 border-t border-border">
              <p className="text-sm text-gray-600 dark:text-gray-500 uppercase tracking-wider font-semibold">
                {t("notifications.notifyWhen")}
              </p>
