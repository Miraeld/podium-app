...
export function Sidebar({ wsConnected, collapsed, onToggle }: SidebarProps) {
  ...
  return (
    ...
    >
      {/* Brand — extra top padding so the native macOS traffic lights
          (overlay titlebar) don't overlap the logo. */}
      <div className="px-3 pt-8 pb-4 border-b border-border flex-shrink-0">
