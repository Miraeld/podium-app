 ...
 * A segmented tab UI combines three concerns:
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-2 text-xs font-medium px-3.5 py-2 rounded-lg transition-colors ${
                active
                  ? "bg-surface-4 text-gray-900 dark:text-gray-100 shadow-sm"
                  : "text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-surface-3"
              }`}
            >
                  ...
                  className={`text-[10px] font-semibold rounded-full px-1.5 min-w-[18px] text-center ${
                    tb.key === "activity"
                      ...
                      : active
                        ...
                        : "text-gray-500 dark:text-gray-400 bg-surface-2"
                  }`}
                >
                  {tb.badge}
                </span>
                ...
                >
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      <span
                        className={`text-sm font-medium truncate ${rule.enabled ? "text-gray-900 dark:text-gray-200" : "text-gray-500 line-through"}`}
                      >
                        {rule.name}
                      </span>
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    <button
                      ...
                      className={`text-xs px-2.5 py-1.5 rounded-md border transition-colors ${
                        rule.enabled
                          ...
                          : "border-border text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-surface-3"
                      }`}
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-md text-gray-500 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-500/10 transition-colors"
        ...
        <div className="card p-4">
          <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
            <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-200">
              {t("feed.title")}
              {unacked > 0 && (
                <span className="ml-2 text-[10px] font-semibold text-amber-600 dark:text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded-full px-2 py-0.5">
                ...
                {alerts.map((alert) => (
                  ...
                  >
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <BellRing
                          className={`w-3.5 h-3.5 flex-shrink-0 ${alert.acknowledged_at ? "text-gray-500" : "text-amber-500 dark:text-amber-400"}`}
                        />
                    ...
                    {!alert.acknowledged_at && (
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 text-xs px-2.5 py-1.5 rounded-md border border-border text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-surface-3 transition-colors flex-shrink-0"
                      >
