...
const NEUTRAL_STYLE = "text-gray-600 dark:text-gray-300 bg-surface-2 border-border";
              ...
              >
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-[11px] px-2.5 py-1 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-surface-4 border border-border transition-colors disabled:opacity-50"
                  >
                    {testing === target.id ? (
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-[11px] px-2.5 py-1 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-surface-4 border border-border transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-[11px] px-2.5 py-1 rounded-md text-gray-500 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-500/10 border border-border transition-colors"
                  >
        ...
        <div className="border border-border rounded-lg p-4 space-y-3 bg-surface-1">
          ...
          <div className="rounded-lg border border-border bg-surface-2/40 overflow-hidden">
            <button
              ...
              className="w-full flex items-center justify-between gap-2 px-3 py-2 text-[11px] text-gray-700 dark:text-gray-300 hover:bg-surface-3 transition-colors"
            >
            ...
            {guideOpen && (
              <div className="px-3 pb-3 pt-2 space-y-2.5 border-t border-border">
                <ol className="list-decimal list-inside space-y-1 text-[11px] leading-relaxed text-gray-600 dark:text-gray-400 marker:text-gray-500 dark:marker:text-gray-600">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 border-t border-border">
              {provider.fields.map((f) => (
                <label key={f.key} className="block">
                  <span className="text-[11px] text-gray-500">
                    {f.label}
                    {f.required && <span className="text-red-500 dark:text-red-400"> *</span>}
                  </span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {isEdit && (
                    <Checkbox
                      ...
                      labelClassName="text-[10px] text-gray-500 group-hover:text-gray-700 dark:group-hover:text-gray-400"
                    />
                  )}
                </div>
                {(!isEdit || form.replaceHeaders) && (
                  <div className="space-y-1.5 mt-1.5">
                    {form.headerRows.map((row, i) => (
                      <div key={i} className="flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className="text-gray-600 hover:text-red-500 dark:hover:text-red-400 p-1"
                        >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-[10px] text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
                    >
          ...
          {rules.length > 0 && (
            <div className="pt-1 border-t border-border">
              <Checkbox
                ...
                labelClassName="text-[11px] text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-300"
              />
              {!form.scopeAll && (
                <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-1">
                  {rules.map((rule) => (
                    <Checkbox
                      ...
                      label={rule.name}
                      labelClassName="text-[11px] text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-300 truncate"
                    />
                  ))}
                </div>
              )}
          ...
          <div className="flex items-center gap-3 pt-1">
            <label className="inline-flex items-center gap-2 text-[11px] text-gray-600 dark:text-gray-400 cursor-pointer">
