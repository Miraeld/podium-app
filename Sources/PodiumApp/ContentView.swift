...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .background(Group {
            ...
            Button("") { selection = .workflows }.keyboardShortcut("6", modifiers: .command)
            Button("") { selection = .importSession }.keyboardShortcut("7", modifiers: .command)
            Button("") { selection = .run }.keyboardShortcut("8", modifiers: .command)
